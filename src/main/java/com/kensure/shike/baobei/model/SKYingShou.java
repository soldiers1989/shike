 ...
 * @since
 */
public class SKYingShou extends BaseInfo {
	...
	private void suanShouXuFei(SKBaobei sk) {
		String d2 = yajin.getXiaoji() + "*2%";
		double xiaoji = ArithmeticUtils.mul(yajin.getXiaoji(), 0.02, 1);
		this.shouxufei = new SKPayInfo("转账手续费", d2, xiaoji);
	}
	...
	private void suanFuWuFei(SKBaobei sk) {
		...
		this.fuwufei = new SKPayInfo("平台服务费", d3, xiaoji3);
	}
