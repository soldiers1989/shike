        ...
        <div class="bd">
            <ul>
                    <li style="display: none;">
                        <a href="#" onclick="clickNumber(45)" target="_blank" style="transition: transform 3s linear; transform: scaleX(1.1) scaleY(1.1);">
                    ...
                    <li style="display: none;">
                        <a href="#" onclick="clickNumber(38)" target="_blank" style="transition: transform 3s linear; transform: scaleX(1.1) scaleY(1.1);">
                    ...
                    <li style="display: list-item;">
                        <a href="#" onclick="clickNumber(39)" target="_blank" style="transition: transform 3s linear; transform: scaleX(1.1) scaleY(1.1);">
