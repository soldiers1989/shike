        ...
        */
        ...
        function drawLinks() {
            ...
            if (next != null && next != 'undefined') {
                var html = "<span id='clickme' style='   width: 74px;height: 70px;  position: relative;  margin: 0 6px 0 0;'><img  src='/Content/images/dwyjx.png' style=' position: absolute;  left: 0;top: 6px;  cursor: pointer;' ></span><span class='pagination_font_color'>&nbsp;&nbsp;";
