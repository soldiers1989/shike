...
%>
<!DOCTYPE html>
<!-- saved from url=(0021)http://m.meilipa.com/ -->
...
<div class="jp-fixed-top">
    ...
    <div class="jp-cat-bg">
        <div class="jp-cat">
            <ul>
                <li>
                    <a href="http://m.meilipa.com/home/list" class="act">全部</a>
                </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=1" class="">女装</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=2" class="">男装</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=4" class="">鞋包</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=7" class="">电器</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=5" class="">百货</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=10" class="">家居</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=6" class="">母婴</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=8" class="">美妆</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=9" class="">配饰</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=3" class="">食品</a>
                    </li>
                    <li>
                        <a href="http://m.meilipa.com/home/list?type=11" class="">车品</a>
                    </li>
            </ul>
        </div>
    </div>
...
<div id="index">
    ...
    <div id="swiper" class="swiper-container swiper-container-horizontal">
        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px); transition-duration: 300ms;">
                <div class="swiper-slide swiper-slide-active" style="width: 354px;">
                    <a href="http://m.meilipa.com/UserAccount/mygold?type=1" onclick="updateAdvClick(43)"><img src="<%=BusiConstant.shikemobilepath %>/index/resource/2a5740e8-b8fc-4061-8253-33febbb34ed4"></a>
                </div>
                <div class="swiper-slide swiper-slide-next" style="width: 354px;">
                    <a href="http://m.meilipa.com/Invitation" onclick="updateAdvClick(59)"><img src="<%=BusiConstant.shikemobilepath %>/index/resource/1a0d3ec3-549c-437a-a0af-baa6c9bf23e1"></a>
                </div>
        </div>
        <!-- 如果需要分页器 -->
    ...
    <ul class="jp-icon">
        <li>
            <a href="http://m.meilipa.com/jing/peoplehit">
                <img src="<%=BusiConstant.shikemobilepath %>/index/resource/icon1.png">
                <span>新人必中</span>
            </a>
        </li>
        <li>
            <a href="http://m.meilipa.com/UserAccount/vip">
                <img src="<%=BusiConstant.shikemobilepath %>/index/resource/icon2.png">
                <span>VIP</span>
            </a>
        </li>
        <li>
                <a href="http://m.meilipa.com/Invitation/BisInvitation">
        ...
        <li>
            <a href="http://m.meilipa.com/Invitation">
        ...
        <li>
            <a href="http://m.meilipa.com/home/list?orderType=2">
...
<script>
    ...
    <div style="display: none"><script src="<%=BusiConstant.shikemobilepath %>/index/resource/z_stat.php" language="JavaScript"></script><script src="<%=BusiConstant.shikemobilepath %>/index/resource/core.php" charset="utf-8" type="text/javascript"></script><a href="http://www.cnzz.com/stat/website.php?web_id=1264685315" target="_blank" title="站长统计">站长统计</a></div>
